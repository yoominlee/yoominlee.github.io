...
<div class="row mt-3 align-items-start">
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_shrimp/1-blue-2.jpg" title="Shrimp Mobile Blue" class="img-fluid rounded z-depth-1" caption="Laser-cut cardboard mobile emphasizing curvature, suspension, and segmented assembly" %}
  </div>
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_shrimp/2-red-3.jpg" title="Shrimp Mobile Red" class="img-fluid rounded z-depth-1" caption="Iterative variation studying silhouette, balance, and body simplification" %}
  </div>
</div>

<div class="row mt-3 align-items-start">
  <div class="col-sm-8 mx-auto">
    {% include figure.liquid path="assets/img/projects/D_shrimp/1-silver-4.jpg" title="Shrimp Mobile Black" class="img-fluid rounded z-depth-1" caption="Side view highlighting profile-based construction and the relationship between flat parts and spatial depth" %}
  </div>
</div>