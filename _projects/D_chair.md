...
<div class="row mt-3 align-items-start">
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_chair/image-pair.png" title="Acrylic Chair Pair" class="img-fluid rounded z-depth-1" caption="Two chair studies exploring contour layering, transparency, and fluorescent color variation" %}
  </div>
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_chair/image-single.png" title="Acrylic Chair Side View" class="img-fluid rounded z-depth-1" caption="Side view showing how stacked acrylic profiles build volume from a minimal outline" %}
  </div>
</div>
...
<div class="row mt-3 align-items-start">
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_chair/process-1.jpg" title="Process Documentation 1" class="img-fluid rounded z-depth-1" caption="Documenting the prototype and evaluating light, edge condition, and material presence" %}
  </div>
  <div class="col-sm-6">
    {% include figure.liquid path="assets/img/projects/D_chair/process-2.jpg" title="Process Documentation 2" class="img-fluid rounded z-depth-1" caption="Prototype review during the final presentation and documentation stage" %}
  </div>
</div>